        ...
        <div class="dashboard_content_container" id="dashboard_content_container" style="height: auto;">
            ...
            <div class="dashboard_Main">
                <div class="dashboard_content_main">
                    <div class="row">
                    <div class="column column-12"> <h1 class="section_header"><i class="fa fa-list"></i>List of Users</h1>
                        <div class="users">
                                        <p class="userCount">"We currently have a total of 
                                        <?= count($users)?> Users"</p>
                            <table>
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a 
                                                href="" class="updateUser"data-userid="<?= $user['id']?>">
                                                <i class="fa fa-pencil" ></i>Edit
                                            </a>
                                            <a 
                                                href="" class="deleteUser" data-userid="<?= $user['id']?>"  
    ...
    if(classList.contains('updateUser')){
                        ...
                        $.ajax({
                            ...
                            dataType: 'json',
                                ...
                                callback: function(){ //it will reload the page automatically without you noticing.
                                location.reload();
                                }
                                });
                                }else 
